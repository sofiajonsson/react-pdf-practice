...
function diffPixels(pageCanvas, firstDocCanvas, firstDocData) {
  ...
  for (var i = 0; i < secondDocData.length; i += 4) {
    ...
    if (isPixelWhite(firstDocData, index) && isPixelWhite(secondDocData, index)) {
      ...
      var lightness = (secondDocData[index] + secondDocData[index + 1] + secondDocData[index + 2]) / 6;
      ...
      if (coords.y <= firstDocCanvas.height && coords.x <= firstDocCanvas.width) {
        if (isPixelWhite(firstDocData, index)) {
          var lightness = (secondDocData[i] + secondDocData[i + 1] + secondDocData[i + 2]) / 3;
          ...
          var lightness = (firstDocData[index] + firstDocData[index + 1] + firstDocData[index + 2]) / 3;
          ...
          var lightness = (firstLightness + secondLightness) / 2;
